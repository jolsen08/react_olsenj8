...
class Team extends React.Component<any,any>{
  render() {
    ...
    //This will display the school, mascot name, and location for each school in the json
    return(
      <div>
...
//This function allows the Team class to iterate through every school in the json
function schoolList() {
  return (
    <div>
      {colleges.map(oneTeam => <Team {...oneTeam}/>)}
    </div>
  );
}
